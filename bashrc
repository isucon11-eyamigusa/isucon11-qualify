...
export PATH=/home/isucon/git/tools:$PATH

alias gita="git -c user.name=aoirint -c user.email=aoirint@gmail.com"
alias gitc="git -c user.name=chamegashi -c user.email=msymsy0693wrb@gmail.com"
